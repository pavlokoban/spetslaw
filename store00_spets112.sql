...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.2&nocache=3908100273ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/printview.css?v=5.1.2" media="print" id="printcss">
    <title>phpmyadmin.adm.tools / store00.mysql.ukraine.com.ua | phpMyAdmin 5.1.2</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/cross_framing_protection.js?v=5.1.2"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=ru&v=5.1.2"></script>
...
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"ru",server:"1",table:"",db:"",token:"767d2e594a445b7445553d4739655e78",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Обзор",pma_text_left_default_tab:"Структура",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"7200",logged_in:true,is_https:true,rootPath:"/",arg_separator:"&",PMA_VERSION:"5.1.2",auth_type:"signon",user:"store00_spets112"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wffilemods">`store00_spets112`.`un_wffilemods`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wffilechanges">`store00_spets112`.`un_wffilechanges`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wfcrawlers">`store00_spets112`.`un_wfcrawlers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wfconfig">`store00_spets112`.`un_wfconfig`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wfblockediplog">`store00_spets112`.`un_wfblockediplog`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wfblocks7">`store00_spets112`.`un_wfblocks7`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_wfstatus">`store00_spets112`.`un_wfstatus`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_users">`store00_spets112`.`un_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=wp_options">`store00_spets112`.`wp_options`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store00_spets112&table=un_redirection_items">`store00_spets112`.`un_redirection_items`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="767d2e594a445b7445553d4739655e78">
...
</span><small>Группировать пункты в дереве навигации (определяется разделителем, указанным в закладках баз данных и таблиц сверху).</small></th><td><span class="checkbox custom"><input type="checkbox" name="NavigationTreeEnableGrouping" id="NavigationTreeEnableGrouping"></span><a class="restore-default hide" href="#NavigationTreeEnableGrouping" title="Восстановить изначальное значение"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="NavigationTreeEnableExpansion">Включить раскрытие навигационного дерева</label><span class="doc"><a href="./doc/html/config.html#cfg_NavigationTreeEnableExpansion" target="documentation"><img src="themes/dot.gif" title="Документация" alt="Документация" class="icon ic_b_help"></a>
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="store00.mysql.ukraine.com.ua">
        Сервер:        store00.mysql.ukraine.com.ua
      </a>
    </li>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Нажмите Enter для выполнения запроса                    </span>
                            ...
                            targetdb="store00_spets112" targettable="un_wfstatus">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfstatus`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wfblockediplog">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfblockediplog`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wfblocks7">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfblocks7`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wfblockediplog">
                            <div class="action_content">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfblockediplog`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wfconfig">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfconfig`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wfcrawlers">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wfcrawlers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wffilechanges">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wffilechanges`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store00_spets112" targettable="un_wffilemods">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `un_wffilemods`</span>
                        </div>
